...
int main(void)
{
    ...
    for (int i = 0; i < height; i++)
    {
        ...
        for (int j = i + 1; j > 0 && j < height; j++)
        {
            printf(" ");
        }
        // prints left pyramid in dependency to i
        for (int k = 0; k <= i; k++)
        {
            printf("#");
        }
        // spacings in between the two pyramids which stay equal in size and printed in each row
        printf("  ");
        // prints right pyramid in dependency to i
        for (int l = 0; l <= i; l++)
        {
            printf("#");
        }
